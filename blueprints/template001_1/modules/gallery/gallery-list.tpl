								...
								<table class="table-h-striped">
									...
									{foreach $groups['video'] as $video}
										...
										<tr>
											...
											<td><a href="{$videoUrl}" title="{$text.DOWNLOAD}" target="_blank" rel="noopener">{$text.DOWNLOAD}</a></td>
										</tr>
									{/foreach}
									</tbody>
								</table>
								...
								<table class="table-h-striped">
									...
									{foreach $groups['document'] as $document}
										...
										<tr>
											...
											<td><a href="{$documentUrl}" title="{$text.DOWNLOAD}" target="_blank" rel="noopener">{$text.DOWNLOAD}</a></td>
										</tr>
									{/foreach}
									</tbody>
								</table>
