...
<div class="modules m-blog" itemscope itemtype="http://schema.org/BlogPosting">
    ...
    <div class="modules m-blog-post">
        ...
        <article>
            ...
            {include file="modules/widgets/slider/slider.tpl" placeholderSelector=".m-blog-post" widgetSettings=$sliderSettings alt=$item->Title type=blog id=$item->Id microdata=true}
    ...
    <div class="row m-blog-commets-container">
        <div class="modules m-blog-comments">
            ...
            <div class="col-s-4 col-m-12 col-l-12 col-xl-24 form-wrap">
                ...
                <button type="submit" class="button button-icon button-primary is-block is-hidden" data-blog="reply-post" data-parentId="0"><i class="fa fa-comment-o"></i>{$text.BLOG_COMMENT_WRITE_TO_POST}</button>
