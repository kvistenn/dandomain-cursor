...
<div class="col-s-2 col-m-3 col-l-4 col-xl-6 category-item" data-mh="category-item">
	...
	<article class="category-item-content">
		...
		<figure class="category-item-image">
			...
			{if $image}
				{$imgpath = $image->thumbnail(293, 293, $crop)|solutionPath}
			{else}
				{$imgpath = $placeholder->getRelativeFile()|solutionPath}
			{/if}
      <a class="placeholder-wrapper trailing-db" href="/{$pagelink}/{$item->Handle}/" title="{$item->Title}" data-placeholder-max-width="293px">
