$(function () {
    ...
    var languageIso = (window.platform && window.platform.general && window.platform.general.languageIso) ? window.platform.general.languageIso : null;
    var forceCompany = (languageIso === 'SE26' || languageIso === 'DE26');

    if (forceCompany) {
        toggleActiveInputs('company');
    } else if ($cvrEl.length && cvr !== '') {
