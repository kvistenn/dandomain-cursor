...
<aside data-sidebar="sidebar" class="fixed z-50 w-[24rem] max-w-full h-full bg-white left-0 top-0 -translate-x-full transition-all min-h-[100dvh] [&.show]:translate-x-0">
