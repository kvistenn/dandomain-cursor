;(function ($, exports) {
	...
	function handleAccordion() {
		var accordion = $('[data-accordion="container"]');
		var accordionTitle = accordion.find('[data-accordion="title"]');
		var accordionContent = accordion.find('[data-accordion="content"]');

		accordionTitle.on('click', function() {
			var $this = $(this);
			var content = $this.parent().find('[data-accordion="content"]');
	...
	$(function() {
		...
		/* ZIP SmartForm */
		$('[data-smartform="zipcode"]').each(function() {
			var $this = $(this);
			var target = $this.attr('data-target');
			var $target = $(target);

			$this.SmartForm('county', {target: $target});
		});

		// Handle tabs
		$('[data-tabs="container"]').each(function() {
			var $this = $(this);
			var $tabs = $this.find('[data-tabs*="#"]');
			var $contents = $this.find('[data-tabs="content"]');

			$tabs.on('click', function() {
				var $tab = $(this);
				var target = $tab.attr('data-tabs');
		...
		// Open shop tab with Enter
		/* if(platform.user) {
			$(document).on('keydown', function(e) {
				if (e.key === 'Enter') {
					e.preventDefault();
					$(document).find('[data-tabs="container"] > [data-tabs]').each(function() {
						console.log($(this))
						if($(this).is(':visible')) {
							$(this).find('label').last().click();
