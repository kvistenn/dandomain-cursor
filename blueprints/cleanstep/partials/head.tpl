...
<link rel="preload" href="{$template.path}/assets/fonts/Inter-Regular.ttf" as="font" type="font/ttf" crossorigin>
<link rel="preload" href="{$template.path}/assets/fonts/Inter-Bold.ttf" as="font" type="font/ttf" crossorigin>
