...
<div class="modules m-userlogin">
	<article class="m-userlogin-article">
		...
		<form id="m-userlogin" data-qa="login-page-form" method="post" action="/actions/user/recaptchalogin" autocomplete="off">
			{csrf type="input"}
			...
			<div class="panel panel-border">
				<div class="panel-body">
					<fieldset class="form-group m-userlogin-username">
						...
						<div class="input-group small">
							...
							<input id="m-userlogin-username" data-qa="login-page-email-input" name="username" type="text" class="form-input small input-group-main" placeholder="{$text.LOGIN_USER}" required>
						</div>
					</fieldset>
					<fieldset class="form-group m-userlogin-password">
						...
						<div class="input-group small">
							...
							<input id="m-userlogin-password" data-qa="login-page-password-input" name="password" type="password" class="form-input small input-group-main" placeholder="{$text.LOGIN_PASSWORD}" required>
						</div>
					</fieldset>
				...
				<div class="panel-footer">
					<button class="form-submit {if !empty($modalCallToActionStyle) AND $modalCallToActionStyle eq "primary"}button-primary{else}button{/if} small" data-qa="login-page-submit-button" type="submit">{$text.LOGIN_MENU}</button>
				</div>
			</div>
		</form>
	</article>
