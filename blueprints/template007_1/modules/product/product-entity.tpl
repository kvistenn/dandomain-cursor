        ...
        <div class="row">
            ...
            <div class="{$productEntityClass}">
                ...
                <div class="m-product-information product-information" id="zoomHook">
                    ...
                    <header class="m-product-title page-title"><h1 class="m-product-title product-title" data-qa="product-page-title" itemprop="name">{$title}</h1></header>
                                ...
                                {if !$item->CallForPrice}
                                    ...
                                    {foreach $priceData as $priceDataInterval}
                                        ...
                                        <span class="is-block m-product-priceline">
                                            ...
                                            <span class="h4 m-product-price" data-qa="product-page-price">{$priceDataInterval->PriceMin|formatPrice}</span>

                                            {if $priceDataInterval->PriceMin lt $priceDataInterval->FullPriceMin}
                                                {* Price before discount *}
                                                <span class="h5"><s class="m-product-price-before-discount" data-qa="product-page-price-discount">{$priceDataInterval->FullPriceMin|formatPrice}</s></span>
                                            {/if}
                                        </span>
