	...
	_.extend(exports.platform, {
	    ...
	    fancybox: {
		    ...
		    init: function () {
				...
				if ( platform.template.settings.BUNDLE_VERSION && platform.template.settings.BUNDLE_VERSION !== "1.0.0" ) {
					$(function() {
						$('.modules.m-productlist.m-productlist-list').on('click', '.m-productlist-price-terms > a', function (e) {
							e.preventDefault();
							$.fancybox.open('#overlaypriceTerms', this.settingsDefault);
						});
					})
				}
		    }
